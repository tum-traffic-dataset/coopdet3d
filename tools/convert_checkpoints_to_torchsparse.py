...
def main():
    ...
    for key in model:
        if key.startswith("nodes.vehicle.fusion_model.encoders.lidar.backbone") or key.startswith("nodes.infrastructure.fusion_model.encoders.lidar.backbone") and ".bn." not in key:
